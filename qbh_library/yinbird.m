...
if nargin<7 || isempty(wsize), wsize=.2; end
if nargin<8 || isempty(hop), hop=.5; end
...
for nseg=1:Nseg
    ...
    out=yinK(audioFile,p); % use YIN to analyze entire audio with the given min frequency 
    beg=nseg*ssize-ssize+1;
    if quality==1, f0=out.good; elseif quality==0, f0=out.f0; elseif quality==2, f0=out.best; end
%%%%%%%%%%%PROBLEM HERE%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% VISUALIZE
if nargout==3
    fmax_fig=max(F_yb)+3000; % Hz; maximum frequency for the spectrogram
